...
plot(x=datosplot$DateTime, y=datosplot$Global_active_power, type="n")
...
plot(x=datosplot$DateTime, y=datosplot$Global_reactive_power, type="n", ylab = "Voltage", xlab = "datetime")
